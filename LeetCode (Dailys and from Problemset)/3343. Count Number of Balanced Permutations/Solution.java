...
class Solution {
  ...
  private final long[] factorials = new long[MAX_SIZE];
  private final long[] inverseFactorials = new long[MAX_SIZE];
  ...
  private void initializeInverseFactorials() {
  ...
  private long modularPow(long base, int exponent) {
    long result = 1;
    while (exponent > 0) {
      if (exponent % 2 == 1) {
